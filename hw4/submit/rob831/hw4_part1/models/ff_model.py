...
class FFModel(nn.Module, BaseModel):
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        target = normalize((next_observations - observations), self.delta_mean, 
                            self.delta_std)
        ...
        predictions =  self(observations, actions, self.obs_mean, self.obs_std, self.acs_mean, self.acs_std,
                                    self.delta_mean, self.delta_std)[1]
